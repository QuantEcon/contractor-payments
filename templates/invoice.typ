// invoice.typ — Milestone invoice PDF template.
//
// Renders a single-page milestone invoice from submission data. Reads the
...
#align(center)[
  #text(size: 15pt, weight: "bold", fill: primary, tracking: 2pt)[QUANTECON INVOICE]
]
...
// ── Totals panel — single Amount payable row ──────────────────────────────
